...
# 引入 StandX 策略 (假设您将上一段代码保存为了 strategy/standx_arb.py)
try:
...
def parse_arguments():
    ...
    parser.add_argument('--exchange', type=str, default='edgex',
                        help='Exchange to use (edgex, standx)')
    ...
    parser.add_argument('--long-threshold', type=Decimal, default=Decimal('10'),
                        help='Long threshold for exchange (default: 10)')
    parser.add_argument('--short-threshold', type=Decimal, default=Decimal('10'),
                        help='Short threshold for exchange (default: 10)')
